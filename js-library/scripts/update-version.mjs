...
const updateVersion = async () => {
  ...
  if (packageName === undefined || currentVersion === undefined) {
    throw new Error("package.json should have name and version fields.");
  }

  const project = packageName.replace("@dfinity/", "");
